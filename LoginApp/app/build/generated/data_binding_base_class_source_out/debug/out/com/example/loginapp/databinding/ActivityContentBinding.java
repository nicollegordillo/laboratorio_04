...
public final class ActivityContentBinding implements ViewBinding {
  ...
  @NonNull
  public final Button getDate;

  @NonNull
  public final TextView tvMensaje;

  private ActivityContentBinding(@NonNull ConstraintLayout rootView, @NonNull Button button4,
      @NonNull Button getDate, @NonNull TextView tvMensaje) {
  ...
  public static ActivityContentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.getDate;
      Button getDate = ViewBindings.findChildViewById(rootView, id);
      if (getDate == null) {
        break missingId;
      }
      ...
      return new ActivityContentBinding((ConstraintLayout) rootView, button4, getDate, tvMensaje);
    }
